...
function HeroResearchPanel() {
  ...
  return (
    <div className="gradient-border-wrap w-full max-w-md lg:ml-auto">
      <div className="inner relative overflow-hidden border border-cyan-900/10 bg-gradient-to-br from-white via-sky-50/40 to-cyan-50/30 p-6 shadow-[0_1px_0_rgba(8,145,178,0.12)]">
        <div
          className="pointer-events-none absolute inset-y-0 left-0 w-1 bg-[var(--gradient-brand)] opacity-90"
          aria-hidden
        />
        <div className="relative pl-4">
          <Tag className="border-cyan-900/15 bg-cyan-50/50 text-cyan-900">Research practice</Tag>
          <h3 className="mt-4 font-mono text-[11px] font-semibold uppercase tracking-[0.14em] text-cyan-950">
          ...
          <ul className="mt-5 space-y-4 border-t border-cyan-900/10 pt-5">
            {rows.map((row) => (
          ...
          <div className="mt-5 space-y-0.5 border-t border-zinc-200 pt-4">
            <div className="h-px w-full max-w-[280px] bg-cyan-700/30" />
            <div className="h-px w-full max-w-[220px] bg-cyan-600/22" />
            <div className="h-px w-full max-w-[160px] bg-cyan-600/14" />
          </div>
        </div>
      </div>
    </div>
    ...
    <>
      ...
      <main className="flex-1">
            ...
            <Container className="flex flex-1 flex-col py-10 pb-0 md:py-14">
              <HeroStaggerRoot className="flex flex-1 flex-col">
                  ...
                  <div className="flex gap-5 md:gap-6">
                    ...
                    <HeroColumnStagger className="min-w-0 flex-1">
                      ...
                      <HeroLineItem className="mt-5">
                        <h1 className="max-w-xl font-sans text-[clamp(2rem,5.5vw,3.5rem)] font-semibold leading-[1.08] tracking-tight text-zinc-900">
                          A{" "}
                          <span className="font-serif-display text-[1.05em] font-semibold italic text-zinc-900">
                            research
                          </span>{" "}
                          firm for {STRIP_MANDATE}
                        </h1>
                      </HeroLineItem>
                ...
                <HeroStaggerChild className="mt-14 pt-8 md:mt-16 md:pt-10">
                  ...
                  <PartnersMarquee labels={partnersMarqueeLabels} />
                </HeroStaggerChild>
              </HeroStaggerRoot>
            </Container>
          </HeroEntrance>
            ...
            <Container>
              <div className="max-w-3xl">
                ...
                <h2 className="font-sans text-3xl font-semibold leading-tight tracking-tight text-zinc-900 md:text-4xl lg:text-[2.75rem]">
                  The best outcomes in crypto, fintech, deep tech, and anything in between are{" "}
        ...
        <SectionReveal amount={0.07}>
          <section
            id="thesis"
            className="scroll-mt-24 border-b border-zinc-200 bg-white py-16 md:py-24 mesh-bg"
          >
            <Container>
              <div className="grid gap-12 lg:grid-cols-2 lg:gap-0">
                <div className="min-w-0 lg:border-r lg:border-dashed lg:border-zinc-300 lg:pr-12">
                  ...
                  <ThesisAiCallout>
                    <p className="font-mono text-[9px] font-semibold uppercase tracking-[0.2em] text-cyan-900">
                      AI on the desk
                    </p>
                    <p className="mt-2 font-serif-display text-sm leading-relaxed text-zinc-800">
                      We spearhead research workflows with{" "}
                      <span className="font-semibold text-cyan-950">AI agents</span>—custom pipelines for
                      ingestion, stress-testing, and publication—and actively support that development so
                      rigor scales without becoming opaque.
                    </p>
                  </ThesisAiCallout>
                ...
                <ThesisFocusSteps steps={focusSteps} />
              </div>
            </Container>
          </section>
        </SectionReveal>
          ...
          <Container className="grid gap-10 md:grid-cols-2 md:items-stretch md:gap-8">
            <div className="flex flex-col justify-center border border-dashed border-zinc-400 bg-white p-4 md:p-8">
              ...
              <h2 className="mt-2 font-sans text-3xl font-semibold leading-tight tracking-tight text-zinc-950 md:text-4xl">
                Building in <span className="text-cyan-800">crypto</span>,{" "}
                <span className="text-cyan-800">fintech</span>,{" "}
                <span className="text-cyan-800">deep tech</span>—or anywhere in between?
              </h2>
              <p className="mt-4 font-serif-display text-base leading-relaxed text-zinc-800">
