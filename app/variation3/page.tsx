...
export const metadata: Metadata = {
  title: "Meridia — The frontier, clearly",
  description:
                  ...
                  <HeroColumnStagger>
                    ...
                    <HeroLineItem className="mt-7">
                      <h1
                        ...
                        style={{ fontSize: "clamp(2.75rem, 8.5vw, 6.25rem)", color: CREAM }}
                      >
              ...
              <Container>
                <HeroStaggerChild>
                  <div className="grid gap-10 lg:grid-cols-2 lg:gap-20">
                    ...
                    >
                      The most consequential technologies of the next decade are being built right
                      now—in crypto protocols, fintech rails, and frontier AI. We research these
                      systems with rigor and act with precision.
                    </p>
              ...
              <div className="grid gap-14 lg:grid-cols-2 lg:gap-20">
                <div>
                  ...
                  <h2
                    ...
                    style={{ fontSize: "clamp(1.85rem, 4vw, 3.25rem)", color: VOID }}
                  >
                  ...
                  <p
                    ...
                    style={{ color: "#4a4540" }}
                  >
                    Frontier technology moves too fast for surface-level diligence. We go deep so
                    that when we act, the work is already done—and you can read every step.
                  </p>
                </div>
                <div>
                  <p
          ...
          >
            <Container>
              ...
              >
                ...
                <Underline>technologies</Underline> of the next decade.
              </h2>
              <div className="mt-14 grid gap-0">
                ...
                <div className="border-t" style={{ borderColor: VOID_BORDER }} />
              </div>
            </Container>
          </section>
        </SectionReveal>
                ...
                <div className="lg:col-span-7">
                  <blockquote>
                    <p
                      ...
                      style={{ fontSize: "clamp(1.7rem, 4vw, 3rem)", color: CREAM }}
                    >
                      &ldquo;We are living through the fastest rewrite of financial
                      infrastructure in human history. Most are watching. We&apos;re{" "}
                      <Underline>inside it</Underline>.&rdquo;
                    </p>
                    <footer className="mt-8 flex items-center gap-3">
                      <div className="h-px w-8" style={{ background: CREAM_DIM }} />
                      <p
                ...
                <div className="lg:col-span-5 lg:flex lg:flex-col lg:justify-end">
                  ...
                  >
                    <p
                      ...
                      style={{ color: CREAM_MUTED }}
                    >
                      Crypto, fintech, and deep tech are not separate bets. They are a single
                      thesis: the infrastructure layer of the next economy is being built right
                      now, and the window to understand it clearly is narrow.
                    </p>
                    <p
                      className="mt-4 font-serif-display text-sm leading-relaxed"
                      style={{ color: CREAM_DIM }}
                    >
                      We exist to keep that window open—through research anyone can read and
        ...
        <SectionReveal amount={0.07}>
          ...
          >
            <Container>
              ...
              >
                Two seats.{" "}
                <Underline>One research bar.</Underline>
              </h2>
              <p
                  ...
                  return (
                    <StaggerItem key={member.handle}>
                      <article
                        ...
                        style={{ borderColor: VOID_BORDER, background: VOID_SURFACE }}
                      >
                        ...
                        <div className="relative flex justify-center px-7 pt-7 md:justify-start">
                          <div
                            ...
                            style={{ background: "#1e1e1e" } as React.CSSProperties}
                          >
                            <Image
                              src={member.image}
                        ...
                        <div className="relative flex flex-1 flex-col px-7 pb-7 pt-6">
                          <div className="h-px w-10" style={{ background: CREAM + "55" }} />
                          <p
                            className="mt-4 font-mono text-[10px] font-medium uppercase tracking-[0.2em]"
                            style={{ color: CREAM }}
                          >
                            {member.handle}
                            <span className="mx-1.5 font-normal" style={{ color: CREAM_DIM }}>
                              ·
                            </span>
                            <span style={{ color: CREAM_MUTED }}>{member.city}</span>
                          </p>
                          <p
                          ...
                          <a
                            ...
                            style={{ color: CREAM_MUTED, textDecorationColor: VOID_BORDER }}
                          >
                            Profile on X ↗
                          </a>
                        </div>
          ...
          >
            <Container>
              <div className="grid gap-14 lg:grid-cols-2 lg:gap-20">
                ...
                <div className="border p-8 md:p-10" style={{ borderColor: "#ccc5bb", background: "white" }}>
                  <p
